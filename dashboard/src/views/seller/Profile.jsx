...
const Profile = () => {
    ...
    // Datos estáticos para simular la información del usuario
    const userInfo = {
        name: "John Doe",
    ...
    const add_image = (e) => {
        if (e.target.files.length > 0) {
            ...
            // Aquí puedes simular la subida de imagen si fuera necesario
        }
    }
    ...
    useEffect(() => {
        if (successMessage) {
            ...
            // Simulación de la limpieza de mensajes
        }
    }, [successMessage])

    const add = (e) => {
        e.preventDefault()
        console.log("Profile info added:", state)
        // Simulación del envío de la información del perfil
    }
