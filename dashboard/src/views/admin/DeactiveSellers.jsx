                        ...
                        <tbody className='text-sm font-normal'>
                            {[1, 2, 3, 4, 5].map((d, i) => (
                                <tr key={i}>
                                    ...
                                    <td scope='row' className='py-1 px-4 font-normal whitespace-nowrap'><img className='w-[45px] h-[45px]' src={`http://localhost:3000/images/category/${d}.jpg`} alt="" /></td>
                                    <td scope='row' className='py-1 px-4 font-normal whitespace-nowrap'>
                                        <span>Yeffer sime</span>
                                    </td>
                                    <td scope='row' className='py-1 px-4 font-normal whitespace-nowrap'>
                                        <span>yeffer.sime@tecsup.edu.pe</span>
                                    </td>
